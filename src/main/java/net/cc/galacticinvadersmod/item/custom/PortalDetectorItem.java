package net.cc.galacticinvadersmod.item.custom;
...
public class PortalDetectorItem extends Item {
    public PortalDetectorItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        ...
        if(!pContext.getLevel().isClientSide()) {
            ...
            if (!foundBlock) {
                player.sendSystemMessage(Component.literal("No Rift Found!"));
            }
